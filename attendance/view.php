                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center" style="font-size: 50px; font-weight: bold;"><?= htmlspecialchars($row['student_id_no']) ?></p>
                                        <p class="card-text text-center" style="font-size: 50px; font-weight: bold;"><?= htmlspecialchars($row['course']). ' - ' .htmlspecialchars($row['year_level']) ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
