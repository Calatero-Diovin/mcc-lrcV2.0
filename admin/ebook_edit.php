                                   ...
                                   <div class="row d-flex justify-content-center mt-5">
                                        ...
                                        <div class="col-12 col-md-5">
                                             <div class="mb-3 mt-2">
                                                  ...
                                                  <input type="text" id="title" name="title" value="<?=$book['title'];?>" class="
                                                       form-control">
                                             </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-5">
                                             <div class="mb-3 mt-2">
                                                  ...
                                                  <input type="text" id="athor" name="author" value="<?=$book['author'];?>" class="
                                                       form-control">
                                             </div>
                                        </div>
                                   ...
                                   <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-12 col-md-5">
                                             <div class="mb-3 mt-2">
                                                  ...
                                                  <input type="text" id="copyright_date" name="copyright_date"
                                   ...
                                   <div class="row d-flex justify-content-center">
                                        <div class="col-12 col-md-5">
                                             <div class="mb-3 mt-2">
                                                  ...
                                                  <input type="file" id="book_file" name="ebook" class="form-control">
                                             </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-5">
                                             <div class="mb-3 mt-2">
                                                  ...
                                                  <input type="file" id="book_image_input" name="opac_image" class="form-control">
                                             </div>
                                        </div>
                                   </div>
