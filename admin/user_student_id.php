...
<div id="bg">
            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 2px solid black; width: 170px; height: 170px; border-radius: 50%;position:absolute;left:0;right:0;top:90px;display:block;margin:0 auto;'>";
                        } else {
    ...
    <div class="id-1">
        ...
        <br>
        <center>
            <img src="../qrcodes/<?php echo htmlspecialchars($qrcode); ?>" alt="Avatar" width="180px" height="180px" style="background-color:transparent;">
            <br>
            <br>
            <br>
                <div class="container" align="center">
