...
<div id="bg">
    <div id="id">
        <br>
            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 4px solid #1176c2; width: 170px; height: 170px; border-radius: 50%;position:absolute;left:0;right:0;top:90px;display:block;margin:0 auto;'>";
                        } else {
                        echo "<img src='assets/img/image.png' height='150px' width='150px' alt='' style='border: 4px solid #1176c2; border-radius: 50%;'>";
                        }
                ?> 
            </center> 
            <br>
            ...
            <div>
            <p style="font-weight:bold;color:black;text-align:center;position:absolute;left:0;right:0;bottom:70px;font-size:11px;"><?php echo "STUDENT NO.".' '.$stu_id; ?></p>
            </div>
            <div>
    ...
    <div class="id-1">
        <p class="text-end" style="font-size:10px;margin-top:13px;margin-right:9px;font-weight:bold;">Birthdate: <?php echo date('F j, Y', strtotime($bdate)); ?></p>
        <br>
        <br>
        <center>
            <img src="../qrcodes/<?php echo htmlspecialchars($qrcode); ?>" alt="Avatar" width="200px" height="200px" style="background-color:transparent;mix-blend-mode: multiply;margin-top:-25px;">
            <br>
            <br>
            <br>
                <div class="container" align="center">
                    <p style="color:black;margin-top:30px;">In case of emergency, please notify:</p>
                    <p class="text-center" style="color:black;margin-top:20px;margin-bottom:-2px;font-size:14px;font-weight:bold;"><?php echo $contact_person; ?></p>
