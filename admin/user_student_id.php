...
<div id="bg">
    ...
    <div class="id-1">
        ...
        <br>
        <center>
            <img src="../qrcodes/<?php echo htmlspecialchars($qrcode); ?>" alt="Avatar" width="200px" height="200px" style="background-color:transparent;mix-blend-mode: multiply;margin-top:-32px;">
            <br>
            <br>
            <br>
                <div class="container" align="center">
