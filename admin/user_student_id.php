    ...
    <div id="id">
        <br>
            ...
            <div class="container" align="center">
                <p style="font-size:13px;font-weight:bold;text-transform:uppercase;color:black;position:absolute;left:0;right:0;bottom:80px;"><?php if(isset($names)){ $namez=$names;echo$namez;} ?></p>
                <br>
            </div>
            <div>
