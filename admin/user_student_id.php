            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 2px solid black; width: 170px; height: 170px; border-radius: 50%;position:absolute;left:0;right:0;top:50px;display:block;margin:0 auto;'>";
                        } else {
