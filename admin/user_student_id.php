...
<div id="bg">
    <div id="id">
        <br>
            ...
            <div>
                <p style="font-size:30px;font-weight:500;color:black;text-align:center;font-family:fantasy;position:absolute;left:0;right:0;bottom:0;letter-spacing:2px;"><?php echo $course; ?></p>
            </div>
    </div>
