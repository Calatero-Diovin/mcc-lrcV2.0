            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 4px solid #1176c2; width: 2in; height: 2in;overflow:hidden;position:absolute;left:0;right:0;top:90px;display:block;margin:0 auto;'>";
                        } else {
