                                                       ...
                                                       <form action="allcode.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row mb-3">
                                                                 ...
                                                                 <div class="col-md-8 col-lg-9">
                                                                      ...
                                                                      >
                                                                      <small id="addressError" class="form-text text-danger" style="display: none;">Please enter the address in the format: Barangay, Municipality, Province</small>
                                                                 </div>
                                                            </div>
                                                            <div class="row mb-3">
