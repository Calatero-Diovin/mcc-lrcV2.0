               ...
               <div class="col mx-auto rounded shadow bg-white">
                    <div class="row">
                         ...
                         <div class="col-sm-12 col-md-6 px-5 " style="margin-top: 60px;">
                              ...
                              <div class="col-md-12">
                                <div class="form-floating mb-3 p-2" style="border: 2px solid #ddd; border-radius: 20px; background-color: #f9f9f9; display: flex; align-items: center; justify-content: space-between; transition: background-color 0.3s;">
