...
<nav class="navbar navbar-expand-lg" style="background: #0096FF;">
    <button id="menu-toggle" class="toggle square ms-3" style="background-color: #fff; color: white;border:none;border-radius:5px;" type="button" aria-label="Toggle navigation">
