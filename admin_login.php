            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 px-5">
                    ...
                    <?php if (isset($_SESSION['lockout_times']) && time() < $_SESSION['lockout_times']): ?>
                        ...
                        ?>
                        <script>
                            // Lockout detected, disable form elements and show message
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                // Optionally, show lockout message
                                // var lockoutMessage = document.createElement('div');
                                // lockoutMessage.classList.add('alert', 'alert-danger');
                                // lockoutMessage.textContent = 'You have been locked out for ' + <?php echo $minutes_remaining; ?> + ' minutes.';
                                // document.getElementById('lockout-message').appendChild(lockoutMessage);
                            });
                        </script>
                    <?php endif; ?>
                    ...
                    <form action="admin_login_code.php" method="POST" class="needs-validation" novalidate>
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <select class="form-select" id="admin_type" name="admin_type" required <?php echo isset($_SESSION['lockout_times']) && time() < $_SESSION['lockout_times'] ? 'disabled' : ''; ?>>
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" id="email" class="form-control" name="email" placeholder="Email" autocomplete="off" required <?php echo isset($_SESSION['lockout_times']) && time() < $_SESSION['lockout_times'] ? 'disabled' : ''; ?>>
                            ...
                            <div class="form-floating mb-3 position-relative">
                                <input type="password" id="password" class="form-control" name="password" placeholder="Password" required <?php echo isset($_SESSION['lockout_times']) && time() < $_SESSION['lockout_times'] ? 'disabled' : ''; ?>>
                        ...
                        <div class="d-grid gap-2 md-3 mb-3">
                            <button type="submit" name="admin_login_btn" id="admin_login_btn" class="btn btn-primary text-light font-weight-bolder btn-lg" <?php echo isset($_SESSION['lockout_times']) && time() < $_SESSION['lockout_times'] ? 'disabled' : ''; ?>>Login</button>
                        </div>
